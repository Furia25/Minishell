...
/*   Updated: 2025/04/28 07:16:11 by alpayet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*ev_result(char *str, size_t ev_len, t_minishell *data)
{
	return (ft_substr("vvvcx", 0, 5));
}

static size_t	skip_subshell(char *str)
{
	size_t	i;
